...
const SignUp = () => {
  ...
  let [selectBusiness, setSelectBusiness] =
    React.useState("비즈니스 분야를 선택해 주세요.");
  let [selectInterest, setSelectInterest] =
  ...
  // 지용 유효성 검사 상태 추가
  // 이메일 유효성 검사
  const [isStateEmail, setIsStateEmail] = React.useState(false);
  // 이메일 중복 검사
      ...
      <SignUpWrap>
            ...
            <div className="select-box">
              <div className="selected" onClick={jobopenClose}>
                ...
                >
                  <path
                    xmlns="http://www.w3.org/2000/svg"
                    d="M16.2207159,6.10870583 C16.5916812,5.74209279 16.5932964,5.14609072 16.2243236,4.77749794 C15.8553508,4.40890516 15.2555125,4.40730026 14.8845472,4.77391329 L7.77928409,11.9296701 C7.40827322,12.2963282 7.40670988,12.7039529 7.7757925,13.0725272 L14.8810556,20.2226181 C15.2500929,20.5911471 15.8499315,20.5926484 16.2208326,20.2259713 C16.5917338,19.8592942 16.5932448,19.2632919 16.2242075,18.8947628 L9.75,12.5010986 L16.2207159,6.10870583 Z"
                    transform="translate(12.000000, 12.500000) scale(1, -1) rotate(-270.000000) translate(-12.000000, -12.500000) "
                  ></path>
                </svg>
              </div>
        ...
        <div className="label_wrap">
          <label>
            ...
            <div className="select-box">
              <div className="selected" onClick={businessopenClose}>
                {selectBusiness}
                <svg
                  width="24"
                  height="24"
        ...
        <div className="label_wrap">
          <label>
            ...
            <div className="select-box">
              <div className="selected" onClick={interestopenClose}>
                {selectInterest}
                <svg
                  width="24"
                  height="24"
          ...
          <div className="agree_all">
            <label onClick={AgreeAll}>
              ...
              >
                ...
                <path d={agreePath}></path>
              </svg>
              <input type="checkbox" className="all_checkbox" />
              <span>모두 동의합니다.</span>
            </label>
          </div>
          <div>
