...
const Login = ({setModalOpen}) => {
  ...
  const LoginClickEvent = async () => {
    ...
    if( LoginUserInfo ){
    await axios
      .post(`${SERVER_URL}/api/login`, LoginUserInfo)
      .then((res) => {
        if( res.data.ok ){
      ...
      .catch((e) => console.log(e, e.reponse, e.response.data));
    }
  };
      ...
      <LoginWrap>
        <LoginModal>
          ...
          <Imgbox>
            ...
            <p>
              현재 2,130,221명의 회원이 크몽에서 활동하고 있습니다. <br />
              2,130,221번째 크몽회원이 되어보세요 : ){" "}
            </p>
          </Imgbox>
          ...
          <LoginBox>
            ...
            <SocialBox>
              <div className="social_circle naver">
                <img
              ...
              <div className="social_circle kakao">
                <img
              ...
              <div className="social_circle facebook">
                <img
                  src="https://d2v80xjmx68n4w.cloudfront.net/assets/icon/facebook_logo_white.png"
                  width="32"
                  height="32"
                  alt="소셜 로고"
                />
              ...
              <div className="social_circle google">
                <img
              ...
              <div className="social_circle apple">
                <img
                  src="https://d2v80xjmx68n4w.cloudfront.net/assets/icon/apple_logo.png"
                  width="20"
                  height="24"
                  alt="소셜 로고"
                />
...
let LoginModal = styled.div`
  ...
  border-radius: 8px;
  box-shadow: rgb(0 0 0 / 12%) 0px 3px 6px -4px,
    rgb(0 0 0 / 8%) 0px 6px 16px 0px, rgb(0 0 0 / 5%) 0px 9px 28px 8px;
  display: flex;
  flex-direction: row;
  padding: 0px;
  text-align: left;
